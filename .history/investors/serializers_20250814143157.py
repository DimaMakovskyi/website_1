...
class SavedStartupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {  # дублюємо гарантію поведінки
    ...
    def validate(self, attrs):
        ...
        # для partial update не вимагаємо startup, якщо його не змінюють
    ...
    def create(self, validated_data):
        ...
        # якщо у схемі notes = NOT NULL — гарантуємо порожній рядок
